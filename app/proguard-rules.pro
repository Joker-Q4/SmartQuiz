...
-keep class com.lxj.xpopup.widget.**{*;}# Please add these rules to your existing keep rules in order to suppress warnings.
...
-dontwarn org.osgi.framework.wiring.BundleRevision# Added missing rules from R8
